...
function selectCredential(
  ...
  // Family-less personas intentionally follow candidate order. With OpenAI-only
  // credentials, prefer the ChatGPT/Codex subscription backend before the
  // platform API; explicit gpt/openai model families still select OPENAI_API_KEY.
